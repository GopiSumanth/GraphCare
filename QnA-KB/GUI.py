...
class ChatBotGraph:
	...
	def chat_main(self, sent):
		answer = "Hello, I am GraphCare Bot. How can I help you?"
...
# Menu bar
    ...
    # Options
        ...
        help_option.add_command(label="About GraphCare-Bot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("GraphCare-Bot info")
    def about(self):
    ...
    def send_message_insert(self, message):
        ...
        print(text2)
        strMsg2 = text2
        pr3 = "GraphCare Bot:  : "+ time.strftime('%B %d, %Y' + ' at ' + '%I:%M %p') + "\n"
        self.text_box.configure(state=NORMAL)
